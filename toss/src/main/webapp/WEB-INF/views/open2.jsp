...
<script type="text/javascript">
    ...
    $("#chkAll").click(function() {
        ...
        $("input[name=chk], input[name=chk2], input[name=chkEssential]").prop("checked", isChecked);
    });

    $("input[name=chk], input[name=chk2]").click(function() {
        var total = $("input[name=chk], input[name=chk2]").length;
        var checked = $("input[name=chk]:checked, input[name=chk2]:checked").length;
			...
			<ul class="open_box">
				<li class="checkBox check01">
					<ul class="clearfix">
						...
						<br>
						<label for="chkAll">전체 약관 모두 체크하기
						<input type="checkbox" name="chkAll" id="chkAll" class="chkAll">
						</label>
						<br>
						<label for="chkEssential">필수 약관 모두 체크하기
						<input type="checkbox" name="chkEssential" id="chkEssential" class="chkAll">
					</label>
					</ul>
				</li>
				...
				<li class="checkBox check02">
					<ul class="clearfix">
						<label>[필수]전자금융거래 기본약관 동의</label>
						<input type="checkbox" name="chk">

					</ul>
					<br> <textarea name="" id="textarea">
                    ▣ 전자금융거래기본약관
제1조(목적)
...
제1조(시행일) 이 약관은 2021년 4월 19일부터 시행합니다.
				...
				<li class="checkBox check03">
					<ul class="clearfix">
						<label>[필수]모바일뱅킹 서비스 설명서</label>
						<input type="checkbox" name="chk">
					</ul><br><textarea name="" id="textarea">
                 동의해주세요
       </textarea>
				</li>
				...
				<li class="checkBox check03">
					<ul class="clearfix">
						<label>[필수] 개인정보 제3자 제공 동의서</label>
						<input type="checkbox" name="chk">
					</ul><br><textarea name="" id="textarea">
				그냥 동의하슈
       </textarea>
				...
				<li class="checkBox check04">
					<ul class="clearfix">
						<label>[선택]이벤트 등 프로모션 알림 문자 수신</label>
			...
			<ul class="agree">
				<button class="fpmgBt1" type="button"
						onclick="link('open')">비동의</button>
				<button class="fpmgBt2" type="submit"
						onclick="agreecheck()">동의</button>
			</ul>
		</form>
	</div>
</body>
